...
def ejecutar_agregar_transaccion(blockchain:list) -> None:
    ...
    transaccion = {codigo, remitente, operacion, destinatario, valor}
    
    cc.agregar_transaccion(blockchain, transaccion)
    print("Se agrego exitosamente la transacción.")
...
def ejecutar_contar_veces_aparece_cuenta(blockchain:list) -> None:
    ...
    cuenta = cc.contar_veces_aparece_cuenta(blockchain, id_cuenta)
    
    print("El número de transacciones que contienen a la cuenta",id_cuenta,"es: ",cuenta["remitente"] ," como remitente y",cuenta["destinatario"],"como destinatario")
def ejecutar_buscar_transaccion(blockchain:list) -> None:
    ...
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
    diccionario = cc.buscar_transaccion(blockchain, codigo_tr)
    
    print("La transacción con el código", codigo_tr ,"es: ", diccionario)
...
def ejecutar_validar_bloque(blockchain:list) -> None:
    ...
    validacion = cc.integridad_blockchain(blockchain)
...
def ejecutar_dar_transacciones_entre(blockchain:list) -> None:
    ...
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
    lista_de_transacciones = cc.validar_bloque(blockchain, remitente, destinatario)
    
    print("Las transacciones con el remitente",remitente," y el destinatario",destinatario,"son:", lista_de_transacciones)
...
def ejecutar_dar_transferencia_mayor_valor(blockchain:list) -> None:
    ...
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
    diccionario_transaccion = cc.dar_transferencia_mayor_valor(blockchain)
    
    print("La transacción con mayor valor en el blockchain de Cupicoin es:", diccionario_transaccion)
def ejecutar_calcular_saldo_cuenta(blockchain:list) -> None:
    ...
    # TODO: complete el codigo haciendo el llamado a la funcion del modulo que
    #  implementa este requerimiento e imprimiendo por pantalla el resultado
    saldo = cc.calcular_saldo_cuenta(blockchain, id_cuenta)
    
    print("El saldo de la cuenta ", id_cuenta, "es de",saldo," Cupicoins")
def mostrar_menu():
